...
const genAI = new GoogleGenerativeAI("AIzaSyDz83LLl7dKzYsCZoATDd5boMlgjbRvhhE");
    ...
    <div className="full">
      ...
      <div className='chat-div'>
        <div className='chat-box'>
          ...
          {(load == true || speak) && !playing ? <p style={{ padding: '10px', display: 'flex', alignItems: 'center' }}><lottie-player src="https://lottie.host/8891318b-7fd9-471d-a9f4-e1358fd65cd6/EQt3MHyLWk.json" style={{ width: "50px", height: "50px" }} loop autoplay speed="1.4" direction="1" mode="normal"></lottie-player></p> : <></>}
        </div>
        <div className='msg-box'>
      
          <input placeholder='say Hello' type='text' value={msg} onChange={e => setMsg(e.target.value)} onKeyDown={(e) => { if (e.key === 'Enter') { getResposnse(msg) } }} placeholder='Say Hello!'></input>
